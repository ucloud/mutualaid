...
const TableNameAid = "aid"

// Aid mapped from table <aid>
type Aid struct {
	...
	ExamineStatus  int32   `gorm:"column:examine_status;not null;default:10" json:"examine_status"`
...
// TableName Aid's table name
func (*Aid) TableName() string {
	return TableNameAid
}
